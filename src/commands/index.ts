...
// Command definitions — Hierarchy
import { allWorkspacesCommands } from './workspaces/index.js';
import { allSpacesCommands } from './spaces/index.js';
import { allFoldersCommands } from './folders/index.js';
import { allListsCommands } from './lists/index.js';

// Command definitions — Tasks & Content
import { allTasksCommands } from './tasks/index.js';
import { allCommentsCommands } from './comments/index.js';
import { allChecklistsCommands } from './checklists/index.js';
import { allCustomFieldsCommands } from './custom-fields/index.js';
import { allTagsCommands } from './tags/index.js';
import { allDependenciesCommands } from './dependencies/index.js';

// Command definitions — Views & Tracking
import { allViewsCommands } from './views/index.js';
import { allTimeTrackingCommands } from './time-tracking/index.js';
import { allGoalsCommands } from './goals/index.js';

// Command definitions — Admin & Config
import { allWebhooksCommands } from './webhooks/index.js';
import { allUsersCommands } from './users/index.js';
import { allGuestsCommands } from './guests/index.js';
import { allMembersCommands } from './members/index.js';
import { allTemplatesCommands } from './templates/index.js';
import { allRolesCommands } from './roles/index.js';
...
export const allCommands: CommandDefinition[] = [
  ...
  ...allTasksCommands,
  ...allCommentsCommands,
  ...allChecklistsCommands,
  ...allCustomFieldsCommands,
  ...allTagsCommands,
  ...allDependenciesCommands,
  // Views & Tracking
  ...allViewsCommands,
  ...allTimeTrackingCommands,
  ...allGoalsCommands,
  // Admin & Config
  ...allWebhooksCommands,
  ...allUsersCommands,
